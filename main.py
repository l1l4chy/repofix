...
tl_admin_users = ['lil_l4chy'] #Poner aqui los user con acceso permanente
godlist = ['lil_l4chy'] #Poner aqui los admin 
...
async def onmessage(bot:TelegramClient,ev: NewMessage.Event,loop,ret=False):
    ...
    if username not in tl_admin_users:
        await bot.send_message(ev.chat.id,'❌ ℕ𝕠 𝕥𝕚𝕖𝕟𝕖𝕤 #𝕒𝕔𝕔𝕖𝕤𝕠, 𝕔𝕠𝕟𝕥𝕒𝕔𝕥𝕒 𝕔𝕠𝕟 @lil_l4chy ❌')
        return
    ...
    if '/start' in text:
        reply = '————————》<a href="https://t.me/lil_l4chy">۞lil_l4chy۞</a>《—————————\n'
        reply += '#𝔹𝕠𝕥 𝕡𝕖𝕣𝕥𝕖𝕟𝕖𝕔𝕚𝕖𝕟𝕥𝕖 𝕒 @lil_l4chy\n\n'
        reply += '𝓔𝓷𝓿í𝓮𝓶𝓮 𝓮𝓷𝓵𝓪𝓬𝓮𝓼 𝓹𝓪𝓻𝓪 𝓼𝓮𝓻 #𝓓𝓮𝓼𝓬𝓪𝓻𝓰𝓪𝓭𝓸𝓼\n🔍 𝓜𝓪𝓷𝓭𝓮 /info 𝔂 𝓵𝓮𝓪 𝓭𝓮𝓽𝓪𝓵𝓵𝓪𝓭𝓪𝓶𝓮𝓷𝓽𝓮\n————————》<a href="https://t.me/lil_l4chy">۞lil_l4chy۞</a>《—————————\n'
    ...
    if '/admin' in text:
        ...
        t = '🙋‍♂️🗣 @' + username + '\n\n>> ' +  txc[1]
        print(t)
        message = await bot.send_message(5257382960,txc)
    ...
    if '/up' in text:
        ...
        try:
            ...
            await bot.send_file(ev.chat,txtsendname,
                                caption=f'{txtinfo}',
                                thumb='thumb.png',
                                buttons=[Button.url('lil_l4chy','https://t.me/lil_l4chy')])
